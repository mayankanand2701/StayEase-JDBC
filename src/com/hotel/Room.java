...
public class Room {
    ...
    public void displayAllRooms(Connection con) throws SQLException {
        ...
        System.out.println(" Details of all Rooms : ");
        System.out.println("----------------------------------------------------------------------------");
        ...
        while (rs.next()) {
            ...
            System.out.printf("%-7d | %-20s | %-9.2f | %-10s%n",roomid, roomtype, price, status);
        }
 ...
 // Method to check if room is available and update status
